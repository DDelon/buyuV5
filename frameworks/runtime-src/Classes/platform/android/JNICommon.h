...
#define LOGI(fmt, ...)   __android_log_print(ANDROID_LOG_INFO, "JNI_", fmt, __VA_ARGS__)
#define LOGD(fmt, ...)   __android_log_print(ANDROID_LOG_DEBUG, "JNI_", fmt, __VA_ARGS__)
#define LOGW(fmt, ...)   __android_log_print(ANDROID_LOG_WARN, "JNI_", fmt, __VA_ARGS__)
#define LOGE(fmt, ...)   __android_log_print(ANDROID_LOG_ERROR, "JNI_", fmt, __VA_ARGS__)
