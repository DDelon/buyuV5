...
--Create spr_title
local spr_title = cc.Sprite:create("playerinfo/pinf_pic_title_sjbd.png")
...
btn_getcode:setCapInsets({x = 19, y = 31, width = 1, height = 2})
btn_getcode:setLayoutComponentEnabled(true)
btn_getcode:setName("btn_getcode")
btn_getcode:setTag(379)
