...
layout:setSize({width = 836.0000, height = 544.0000})
...
img_bg_2:setPosition(417.9999, 245.3736)
...
layout:setPercentHeight(0.8382)
layout:setSize({width = 802.0000, height = 456.0000})
layout:setLeftMargin(16.9999)
layout:setRightMargin(17.0001)
layout:setTopMargin(70.6264)
layout:setBottomMargin(17.3736)
...
spr_title:setPosition(0.0000, 230.2776)
...
layout:setTopMargin(-251.2776)
layout:setBottomMargin(209.2776)
...
btn_close:setPosition(384.8062, 239.3322)
layout = ccui.LayoutComponent:bindLayoutComponent(btn_close)
layout:setSize({width = 70.0000, height = 70.0000})
layout:setLeftMargin(349.8062)
layout:setRightMargin(-419.8062)
layout:setTopMargin(-274.3322)
layout:setBottomMargin(204.3322)
...
btn_cancel:setPosition(-200.0000, -178.0000)
...
node_phone:setPosition(-300.0000, 114.0000)
...
image_bg:setCascadeColorEnabled(true)
image_bg:setCascadeOpacityEnabled(true)
image_bg:setPosition(390.0000, 0.0000)
layout = ccui.LayoutComponent:bindLayoutComponent(image_bg)
layout:setPositionPercentYEnabled(true)
layout:setSize({width = 412.0000, height = 62.0000})
...
node_set_password:setPosition(-300.0000, 22.3886)
layout = ccui.LayoutComponent:bindLayoutComponent(node_set_password)
layout:setLeftMargin(-300.0000)
layout:setRightMargin(300.0000)
layout:setTopMargin(-22.3886)
layout:setBottomMargin(22.3886)
...
tf_set:setPosition(190.0000, 0.0000)
...
node_code:setPosition(-300.0000, -66.9135)
layout = ccui.LayoutComponent:bindLayoutComponent(node_code)
layout:setLeftMargin(-300.0000)
layout:setRightMargin(300.0000)
layout:setTopMargin(66.9135)
layout:setBottomMargin(-66.9135)
...
btn_getcode:setCapInsets({x = 18, y = 31, width = 2, height = 2})
...
spr_nosend:setPosition(80.0000, 32.0000)
...
spr_sendend:setPosition(63.9840, 32.0000)
spr_sendend:setScaleX(1.3000)
spr_sendend:setScaleY(1.3000)
...
layout:setLeftMargin(28.9840)
layout:setRightMargin(61.0160)
