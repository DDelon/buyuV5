...
btn_go:loadTextureDisabled("common/btn/com_btn_red2_0.png",0)
...
--Create effect_light
local effect_light = cc.Sprite:create("common/btn/com_btn_red_0.png")
effect_light:setName("effect_light")
effect_light:setTag(36)
effect_light:setCascadeColorEnabled(true)
effect_light:setCascadeOpacityEnabled(true)
effect_light:setPosition(365.0000, -4.0000)
effect_light:setOpacity(0)
effect_light:setColor({r = 143, g = 155, b = 245})
layout = ccui.LayoutComponent:bindLayoutComponent(effect_light)
layout:setSize({width = 158.0000, height = 82.0000})
layout:setLeftMargin(286.0000)
layout:setRightMargin(-444.0000)
layout:setTopMargin(-37.0000)
layout:setBottomMargin(-45.0000)
effect_light:setBlendFunc({src = 770, dst = 1})
panel:addChild(effect_light)
...
AlphaTimeline:setNode(effect_light)
--Create Animation List
local prompt = {name="prompt", startIndex=0, endIndex=120}
result['animation']:addAnimationInfo(prompt)
